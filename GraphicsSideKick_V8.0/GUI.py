        ...
        with open("data.txt","r") as data:
            ...
            for self.data in data:
                ...
                if "t: " not in self.data:
                    ...
                    if len(self.Graph1) > 140:

                        self.Graph1.pop(0)

                    if len(self.Graph2) > 140:

                        self.Graph2.pop(0)

                    if len(self.Graph3) > 140:
            ...
            while waitingForData:
                if not process.waitForNewData:
                    ...
                    if self.minDiagram != True:
                        ...
                        data = mesh.Mesh.from_file('Textures/Rocket.stl')
...
class Window():
    ...
    def animation(self):
        ...
        return animation.FuncAnimation(graphs.fig, graphs.animate, interval=1)
